        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form method="post" class="form d-flex flex-column flex-lg-row" action="{{route('admin.masacap.guncelle',$masacap->id)}}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="rounded-circle {{ $masacap->yayin === 1 ? "bg-success" : "bg-danger"}} w-15px h-15px"></div>
                                    </div>
                                    <!--begin::Card toolbar-->
                                </div>
                                <!--end::Card header-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select" name="yayin">
                                        <option></option>
                                        <option value="1" {{ $masacap->yayin === 1 ? "selected" : ""}}>Published</option>
                                        <option value="0" {{ $masacap->yayin === 0 ? "selected" : ""}}>Unpublished</option>
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('default',$masacap->default, ['class' => 'form-control mb-2 ',  'placeholder' => 'MasaCap Default']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('order',$masacap->order, ['class' => 'form-control mb-2 ',  'placeholder' => 'MasaCap Order']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('name',$masacap->name, ['class' => 'form-control mb-2 ',  'placeholder' => 'MasaCap Name']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('sku',$masacap->sku, ['class' => 'form-control mb-2 ',  'placeholder' => 'MasaCap Sku']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('price',$masacap->price, ['class' => 'form-control mb-2 ',  'placeholder' => 'MasaCap Price']) !!}
