        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form method="post" class="form d-flex flex-column flex-lg-row" action="{{route('admin.malzeme.kaydet')}}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('default',null, ['class' => 'form-control mb-2 ',  'placeholder' => 'Malzeme Default']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('order',null, ['class' => 'form-control mb-2 ',  'placeholder' => 'Malzeme Order']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('name',null, ['class' => 'form-control mb-2 ',  'placeholder' => 'Malzeme Name']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('sku',null, ['class' => 'form-control mb-2 ',  'placeholder' => 'Malzeme Sku']) !!}
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        {!! Form::text('price',null, ['class' => 'form-control mb-2 ',  'placeholder' => 'Malzeme Price']) !!}
